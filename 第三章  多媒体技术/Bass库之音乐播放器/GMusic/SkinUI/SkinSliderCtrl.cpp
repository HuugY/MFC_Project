...
BOOL CSkinSliderCtrl::SetBackImage( LPCTSTR lpszFileName,CONST LPRECT lprcNinePart/*=NULL*/ )
{
...
void CSkinSliderCtrl::OnPaint()
{
	...
	if ( !IsWindowEnabled() )
	{
		...
		{
			m_pDisImg->DrawImage(&MemDC,0,0,rcClient.Width(),rcClient.Height());
		}		
	}
	else
	{
		...
		{
			m_pBackImg->Draw(&MemDC,rcClient);
		}
	}
